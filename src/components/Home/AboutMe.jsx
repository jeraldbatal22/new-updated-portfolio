        ...
        <div className="flex flex-col items-center gap-10 lg:flex-row">
          ...
          <div className="flex-1 flex flex-col justify-center gap-12 h-full">
            ...
            <div className="">
              ...
              <p>Hello, I’m Jerald, but you can call me JB, Jer, or Rald. I am 4 years graduated of Bachelor Science in Hotel and Restaurant Management. I made a significant career shift into software engineering to hone my coding skills and deepen my knowledge in the field. Along this journey, I discovered a strong passion for building and publishing websites.</p>
              <br/>
